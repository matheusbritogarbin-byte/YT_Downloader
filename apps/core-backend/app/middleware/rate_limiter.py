...
class RateLimitMiddleware(BaseHTTPMiddleware):
    ...
    async def dispatch(
        ...
        try:
            ...
            # Correção Definitiva: Converte para string e isola o primeiro IP limpando os espaços sem criar listas erradas
            ip_str = str(raw_ip).split(",")[0]
            client_ip = ip_str.strip()
        except Exception:
            client_ip = "127.0.0.1"
